...
export default {
  ...
  data() {
    ...
    return {
      captchatImg: '',
      swiperList: [require("@/assets/imgs/routine.png"),require("@/assets/imgs/QQ图片20221105193200.jpg")],
      loginLogo:require("@/assets/imgs/QQ图片20221105193200.jpg"),
      backgroundImages: "",
      backgroundImageMo: require("@/assets/imgs/xiao.jpg"),
